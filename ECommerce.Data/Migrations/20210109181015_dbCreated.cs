    ...
    public partial class dbCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignSliders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_UserBaskets_UserBasketId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductComments_AspNetUsers_ModeratorUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "f4b98e45-effe-438d-926f-52c6159eae9f", new DateTime(2021, 1, 9, 21, 10, 14, 915, DateTimeKind.Local).AddTicks(5308), "User", "USER", null });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "CreateDate", "Name", "NormalizedName", "UpdateDate" },
                values: new object[] { 2, "e0c9dde2-ea20-48eb-9804-41a4924cc2c9", new DateTime(2021, 1, 9, 21, 10, 14, 916, DateTimeKind.Local).AddTicks(3387), "Admin", "ADMIN", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "40254b97-9d3f-4ce3-9eab-72b1ee965991", new DateTime(2021, 1, 9, 21, 10, 14, 918, DateTimeKind.Local).AddTicks(9219), "y_gul06@hotmail.com", true, true, null, "y_gul06@hotmail.com", "y_gul06", "AQAAAAEAACcQAAAAEIoMkALFuhNj9mQQhpCMp96fFwZ1X2iL1WCUJLrhaNjHTiO6B/ihNzEZ+jvkQSsfbg==", "5412321962", true, "ZVBXXX6XI7A32A5HTK6SWN6PL5NROBDK", false, null, "y_gul06" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductComments_ModeratorUserId",
